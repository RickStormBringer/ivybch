        ...
        React.createElement("div", { className: "container fixedcontainer" },
            React.createElement("div", { className: "navbar-header" },
                React.createElement(Link, { to: "/create", className: "navbar-brand" },
                    React.createElement("div", { style: { lineHeight: '30px' } }, "Ivy Playground for Bitcoin Cash"))),
            React.createElement(ReactTooltip, { id: "seedButtonTooltip", place: "bottom", type: "error", effect: "solid" }),
            React.createElement("ul", { className: "nav navbar-nav navbar-right" },
                React.createElement("li", null,
                    React.createElement("a", { href: "https://github.com/copernet/ivybch", target: "_blank" }, "GitHub")),
                React.createElement("li", null,
                    React.createElement("a", { href: "https://ivy.copernet.io/docs", target: "_blank" }, "Docs")),
                React.createElement("li", null,
